...
describe('Character class', () => {
  ...
  test('should throw an error for invalid name', () => {
    expect(() => new Bowman('L', 'Bowman')).toThrow('Invalid name. Name should be a string with length between 2 and 10 characters.');
  });

  test('should throw an error for invalid type', () => {
    expect(() => new Bowman('Legolas', 'Archer')).toThrow('Invalid type. Type should be one of: Bowman, Swordsman, Magician, Daemon, Undead, Zombie.');
  });
});
